            ...
            <div className="row m-0 py-5">
                ...
                <div className="col-sm-12 col-md-6">
                    <div className="drone">
                        ...
                        <p>Our drone services provide you with a skilled UAV pilot that will provide aerial drone videography.</p>
                    </div>
                </div>
            </div>
            <div className="row m-0 pb-5">
                <div className="col-sm-12 col-md-6">
                    <div className="drone">
                        ...
                        <p>New intelligent flight mode where drone flies along</p>
